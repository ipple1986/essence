 ...
 *   final concurrent.ReentrantReadWriteLock rwl = new concurrent.ReentrantReadWriteLock();
 *
 ...
 *   private final concurrent.ReentrantReadWriteLock rwl = new concurrent.ReentrantReadWriteLock();
...
public class ReentrantReadWriteLock
    ...
    /**
     * Synchronization implementation for concurrent.ReentrantReadWriteLock.
     * Subclassed into fair and nonfair versions.
     */
    //ReentrantReadWriteLock类的同步器
    abstract static class Sync extends concurrent.AbstractQueuedSynchronizer {
    ...
    public boolean hasWaiters(Condition condition) {
        ...
        if (!(condition instanceof concurrent.AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.hasWaiters((concurrent.AbstractQueuedSynchronizer.ConditionObject)condition);
    }
    ...
    protected Collection<Thread> getWaitingThreads(Condition condition) {
        ...
        if (!(condition instanceof concurrent.AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitingThreads((concurrent.AbstractQueuedSynchronizer.ConditionObject)condition);
    }
