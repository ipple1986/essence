package essentails.zookeeper.usecase.clustermonitor;
...
public class ClusterClient implements Watcher, Runnable {
    ...
    ZooKeeper zk;
    public ClusterClient(String hostPort, Long pid) {String processId = pid.toString();
        try {
    ...
    public static void main(String[] args) {
        ...
        String hostPort = "localhost:2181";//args[0];
        //Get the process id
