...
public class XmlSignatrue {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String storePath = System.getProperty("user.dir")+"/src/main/resources/test.jks";
        keyStore.load(new FileInputStream(storePath),storePass);
        Certificate certificate = keyStore.getCertificate(aliasName);
        PublicKey publicKey = certificate.getPublicKey();

        //sign(keyStore,"src/main/resources/web.xml","src/main/resources/websigned.xml");
        valid(publicKey,"src/main/resources/websigned.xml");
    ...
    public static void valid(PublicKey publicKey,String src) throws Exception {
        ...
        String path = new File("src/main/resources/web.xml").toURI().toString();
        //System.out.println(new File("xml-file-sign-valid-ibm/websigned.xml").exists());
